...
import './App.css';
import { BsTelegram, BsLinkedin, BsMailboxFlag, BsGithub, BsDatabaseFill, BsFillPersonFill, BsCameraFill, BsFillTelephoneFill } from "react-icons/bs";
...
function App() {
  ...
  const items = [
    ...
    { icon: <BsFillTelephoneFill size={18} />, label: 'Contact', onClick: () => contactRef.current?.scrollIntoView({ behavior: 'smooth' }) },
